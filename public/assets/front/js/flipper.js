...
$(".flipper-page-wrap").hide();
setInterval(function() { 
$(".flipper-page-wrap").show();
  $('#slideshow > div:first')
    .fadeOut(3000)
    .next()
    .fadeIn(3000)
...
(function($) {
	...
	Flipper.prototype.initUI = function() {
		h = '';
		if (O.arrows) {
			/*h = '<img src="' + O.imagesPath + 'arrow_next.png" class="flipper-next-page">
			
			<img src="' + O.imagesPath + 'arrow_prev.png" class="flipper-prev-page">'; */
			
			h='<img src="flipper/images/arrow_next.png" class="flipper-next-page"> <img src="flipper/images/arrow_prev.png" class="flipper-prev-page">';
		...
		if (O.pager) {
			...
			for (i=0; i < this.numPages; i++) {
				...
				h += '<img src="flipper/images/pager.png" class="flipper-pager" id="flipper-pager-' + i + '">';
			}
			h += '</div>';
		}			
