...
$(document).ready(function () {
    ...
    datatable = $('#basicDataTable').DataTable({
        ...
        "ordering": false,
        "info": false,
        "ajax": SITE_URL + '/admin/subject/list-ajax',
        "columnDefs": [
            {
                targets: 0,
                data: null,
            ...
            },
            {
                ...
                data: null,
                render: function (data, type, row) {
                    var action_html = '<a class="btn btn-sm btn-default view-log" href="' + SITE_URL + '/admin/subject/edit/' + data[2] + '"><img src="' + SITE_URL + '/assets/admin/images/edit-icon-dark.png"></a>';
