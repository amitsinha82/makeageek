...
@section('title') {{{ 'Edit Subject' }}} @parent @stop {{-- Content --}}
@section('content')
                                ...
                                <div class="row">
                                    <div class="panel-body">
                                        <div class="form-group"> 
                                            ...
                                            <div class="">
                                                <input required="required" type="text" value="<?php echo old('subjcatName') ? old('subjcatName') : (empty($subjcatName) ? '' : $subjcatName) ?>" class="form-control tb-big band_name" name="subjcatName" id="subjcatName" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
