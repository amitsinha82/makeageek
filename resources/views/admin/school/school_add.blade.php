                                ...
                                <div class="row">
                                    <div class="panel-body"> 
                                        <div class="form-group"> 
                                            ...
                                            <div class="">
                                                <input type="text" value="<?php echo old('school_name') ? old('school_name') : (empty($school_name) ? '' : $school_name) ?>" class="form-control tb-big band_name" name="school_name" id="school_name" />
                                            </div>
                                        </div>
                                        <div class="form-group"> 
                                            <label>School Email</label> 
                                            <div class="">
                                                <input type="text" value="<?php echo old('school_email') ? old('school_email') : (empty($school_email) ? '' : $school_email) ?>" class="form-control tb-big band_name" name="school_email" id="school_email" />
                                            </div>
                                        </div>
                                        <div class="form-group"> 
