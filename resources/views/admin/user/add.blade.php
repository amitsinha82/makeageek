...
@section('title') {{{ 'Add User' }}} @parent @stop {{-- Content --}}
@section('content')
                                ...
                                <div class="row">
                                    <div class="panel-body"> 
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="">
                                                <input type="text" value="<?php echo old('co_code') ? old('co_code') : (empty($co_code) ? '' : $co_code) ?>" class="form-control tb-big band_name" name="co_code" id="co_code" />
                                            </div>
                                        </div>
                                        <div class="form-group"> 
                                            <label>Phone</label> 
                                            <div class="">
                                                <input type="text" value="<?php echo old('u_phone') ? old('u_phone') : (empty($u_phone) ? '' : $u_phone) ?>" class="form-control tb-big band_name" name="u_phone" id="u_phone" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="">
                                                <input required="required" type="password" value="" class="form-control tb-big band_name" name="u_password" id="u_password" />
                                            </div>
                                        </div>
                                        <div class="form-group"> 
                                            <label>Confirm Password</label> 
                                            <div class="">
                                                <input required="required" type="password" value="" class="form-control tb-big band_name" name="u_confirm_password"  id="u_confirm_password" />
                                            </div>
                                        </div>
                                    </div>
